...
function readCSV() {
    ...
    reader.onload = function(e) {
        try {
            ...
            showMessage(`📄 ${csvParticipants.length} participants chargés depuis le CSV`, "success");
...
function setupTestButton() {
    const testButton = document.querySelector('button[onclick="testBackgroundSync()"]');
    if (testButton) {
...
console.log('🎮 Application Tournoi Gaming initialisée avec sélecteur de rôle personnalisé');